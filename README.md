...
This mod adds simple client-side triggerbot, aim assist, autocrystal, silentaura, and anchoraura modules. Each module uses bind and toggle values stored in `config/triggerbot-mod.properties`.
